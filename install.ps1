...
if ($currentPrincipal.IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
  ...
  if ($cred) {
      Install-BoxstarterPackage -PackageName https://raw.githubusercontent.com/tghosth/flare-vm/master/hack-build-windows.ps1 -Credential $cred
  } else {
      Install-BoxstarterPackage -PackageName https://raw.githubusercontent.com/tghosth/flare-vm/master/hack-build-windows.ps1
  }
